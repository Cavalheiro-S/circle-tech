...
export const Banner = () => {
    ...
    return (
        <MotionSection id="home" className="px-1 md:px-5">
            <div className="flex flex-col md:flex-row items-center justify-center bg-primary w-full md:max-h-[600px] rounded-sm p-2">
                {/* Lado Esquerdo */}
                <div className="flex flex-col p-2 sm:p-10 md:mx-20 xl:max-w-2xl gap-4 w-full">
                    <h1 className="text-4xl font-semibold text-white font-poppins leading-tight text-center md:text-left">
                        Transformamos tecnologia em soluções que <span className="text-secondary">impulsionam</span> o seu futuro
                    </h1>   
                    <p className="text-white font-inter font-light leading-relaxed text-center md:text-left">
